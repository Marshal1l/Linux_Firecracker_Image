...
#if FIXADDR_TOP > (-UL(SZ_8M))
/* opencca:
 * XXX: Since we multiplex RMM and linux in normal world,
 * TTBR1 mappings in RMM cannot conflict with virtual memory of kernel.
 * Do not touch upper 8 MB of memory.
 */
#error "CONFIG_OPENCCA_RESERVE_ASIDS: Requires 8MB at high mem virtual memory reserved"
#endif
#endif
